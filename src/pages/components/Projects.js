...
const Projects = () => {
  ...
  const projectList = [
    ...
    {"description": "Camera Project 01", "image": cameraProjekt01, "text": "In diesem selbstentwickelten virtuellen Raum kann der User sich frei bewegen und mit verschiedenen Objekten interagieren. Dabei können eigene Fotos aufgenommen werden. Die Website ist mit Three.JS entstanden."},
    {"description": "Camera Project 02", "image": cameraProjekt02, "text": "In diesem selbstentwickelten virtuellen Raum kann der User sich frei bewegen und mit verschiedenen Objekten interagieren. Dabei können eigene Fotos aufgenommen werden. Die Kamera-Vorlage wurde mit Blender erstellt. Die zweite Kamera, sowie der virtuelle Raum in dem diese steht wurden in Three.js entwickelt."},
